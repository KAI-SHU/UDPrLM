...
def main():
    ...
    subparser.add_argument('--embed', type=str, help='path to pretrained embeddings')
    subparser.add_argument('--unk', type=str, help='unk token in pretrained embeddings')
    subparser.add_argument('--n-embed', default=100, type=int, help='dimension of embeddings')
    subparser.add_argument('--bert', default='bert-base-cased', help='BERT model type or BERT model path')
    subparser.add_argument('--n_feat_embed', default=100, type=int, help='dimension of feature embeddings')
    subparser.add_argument('--bert_type', type=str, default='bert', help='which BERT model to use')
    subparser.add_argument('--n_bert_layers', type=int, help='num of bert layers to use')
    subparser.add_argument('--fusion_ud', action='store_true', help='whether to fusion ud repr')
    # evaluate
