...
from transformers.models.bert.modeling_bert import (BertPreTrainedModel, BertModel, BertOnlyMLMHead, BertPreTrainingHeads, BertLayer, BertForPreTrainingOutput, MaskedLMOutput, SequenceClassifierOutput, QuestionAnsweringModelOutput)
...
class UDBertModel(BertPreTrainedModel):
    config_class = UDBertConfig
...
class UDBertForSequenceClassification(BertPreTrainedModel):
    config_class = UDBertConfig
    def __init__(self, config):
        super().__init__(config)
...
class UDBertForQuestionAnswering(BertPreTrainedModel):
    config_class = UDBertConfig
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
