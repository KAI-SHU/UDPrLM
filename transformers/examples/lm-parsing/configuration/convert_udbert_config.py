...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Convert UDBert Model Type')
    parser.add_argument("--input_json", type=str, help="Pretrained UDBert Model Config Input Path")
    parser.add_argument("--input_labels", type=str, help="Pretrained UDBert Model Config Input Path")
    ...
    parser.add_argument("--output_json", type=str, help="Pretrained UDBert Model Config Output Path")
    ...
    config['architectures'][0] = 'UDBertModel'
