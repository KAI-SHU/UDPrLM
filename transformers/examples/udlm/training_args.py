...
class TrainingArguments:
    ...
    per_device_parsing_eval_batch_size: int = field(
        default=4, metadata={"help": "Batch size per GPU/TPU core/CPU for parsing evaluation."}
    )
    ...
    data_dir: Optional[str] = field(
        default=None, metadata={"help": "The input data dir. Should contain the files for the Denpendency Parsing task."}
    )
    train_file: Optional[str] = field(
        default=None, metadata={"help": "The train file name for the Denpendency Parsing task."}
    )
    eval_file: Optional[str] = field(
        default=None, metadata={"help": "The eval file name for the Denpendency Parsing task."}
    )
    predict_file: Optional[str] = field(
        default=None, metadata={"help": "The eval file name for the Denpendency Parsing task."}
    )
    mlm_train_file: Optional[str] = field(
        default=None, metadata={"help": "The input training data file (a text file)."}
    )
    mlm_validation_file: Optional[str] = field(
    ...
    predict_output: Optional[str] = field(
        default=None, metadata={"help": "The predict output file name for the Denpendency Parsing task."}
    )
    ...
    postags:str = field(
        default="", metadata={"help": "Path to a file containing all postag labels."}
    )
    labels:str = field(
        default="", metadata={"help": "Path to a file containing all dependency labels."}
    )
    convert_strategy:int = field(
        default=0, metadata={"help": "Word-level to subword-level dependency tree convert strategy."}
    )
    special_postag:str = field(
        default="_", metadata={"help": "Special postag for the subword due to word-level to subword-level conversion."}
    )
    special_label:str = field(
        default="_", metadata={"help": "Special label for the subword due to word-level to subword-level conversion."}
    )
    config_name:str = field(
        default="", metadata={"help": "Pretrained config name or path if not the same as model_name."}
    )
    tokenizer_name:str = field(
        default="", metadata={"help": "Pretrained tokenizer name or path if not the same as model_name."}
    )
    cache_dir:str = field(
        default="", metadata={"help": "Where do you want to store the pre-trained models downloaded from s3."}
    )
    dataset_cache_dir:str = field(
        default="", metadata={"help": "Where do you want to store the pre-trained models downloaded from s3."}
    )
    max_seq_length:int = field(
        default=384, metadata={"help": "The maximum total input sequence length after tokenization. Sequences longer "
                             "than this will be truncated, sequences shorter will be padded."}
    )
    parsing_max_seq_length:int = field(
        default=300, metadata={"help": "The maximum total input sequence length after tokenization. Sequences longer "
                             "than this will be truncated, sequences shorter will be padded."}
    )
    evaluate_during_training:bool = field(
        default=False, metadata={"help": "Whether to run evaluation during training at each logging step."}
    )
    do_lower_case:bool = field(
        default=False, metadata={"help": "Set this flag if you are using an uncased model."}
    )
    eval_strategy:int = field(
        default=0, metadata={"help": "Eval model strategy. 0 for every X epochs, 1 for every X steps, 2 for every X steps and every epoch."}
    )
    save_strategy:int = field(
        default=0, metadata={"help": "Save checkpoint strategy. 0 for save all checkpoints, 1 for save better checkpoints."}
    )
    ...
    use_auth_token:bool = field(
        default=False, metadata={"help": "Will use the token generated when running `transformers-cli login` (necessary to use this script "
            "with private models)."}
    )
    ...
    pad_to_max_length:bool = field(
        default=False, metadata={"help": "Whether to pad all samples to `max_seq_length`. "
    ...
    parsing_training_prob:float = field(
        default=0.8, metadata={"help": "parsing training probability."}
    )
    parsing_only:bool = field(
        default=False, metadata={"help": "only train parsing."}
    )
    use_ud_repr:bool = field(
        default=False, metadata={"help": "use parsing representation for mlm."}
    )
    fixed_bert_base_lm:bool = field(
        default=False, metadata={"help": "fixed language model."}
    )
    fixed_xlmr_large_lm:bool = field(
        default=False, metadata={"help": "fixed language model."}
    )
    fixed_xlmr_base_lm:bool = field(
        default=False, metadata={"help": "fixed language model."}
    )
    ...
    @property
    def eval_parsing_batch_size(self) -> int:
        """
        The actual batch size for evaluation (may differ from :obj:`per_gpu_eval_batch_size` in distributed training).
        """
        if self.per_gpu_eval_batch_size:
        ...
        per_device_batch_size = self.per_gpu_eval_batch_size or self.per_device_parsing_eval_batch_size
        eval_batch_size = per_device_batch_size * max(1, self.n_gpu)
        return eval_batch_size
