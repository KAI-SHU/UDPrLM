...
class StructuralAttentionLayer(nn.Module):
    ...
    def __init__(self, config, projeciton=True):
        ...
        self.head_WV = nn.Parameter(torch.randn(config.num_labels, hidden_size, hidden_size))
        self.dense = nn.Linear(hidden_size * config.num_labels, config.hidden_size)
...
class BiaffineDependencyParsingHead(nn.Module):
    def __init__(self,
        ...
        self.rel_attn = Biaffine(n_in=config.label_space, n_out=config.num_labels, bias_x=True, bias_y=True)
